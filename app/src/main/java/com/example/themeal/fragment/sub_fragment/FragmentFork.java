...
public class FragmentFork extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_fork, container, false);
    ...
    private void initUI() {
        ...
        r_pork.setLayoutManager(llm);
        apiInterface.getCategory("Pork").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
