 ...
 */
public class Fragment_Starter extends Fragment {
    ...
    @BindView(R.id.rv_starter)
    RecyclerView r_starter;
    @BindView(R.id.progress_load)
    ProgressBar load;


    public Fragment_Starter() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment__starter, container, false);
    ...
    private void initUI() {
        ...
        r_starter.setLayoutManager(llm);
        apiInterface.getCategory("Starter").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_starter.setAdapter(adapterMenu);
