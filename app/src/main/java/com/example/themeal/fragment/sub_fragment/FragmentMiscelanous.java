 ...
 */
public class FragmentMiscelanous extends Fragment {
    ...
    @BindView(R.id.rv_msc)
    RecyclerView r_miscelanous;
    @BindView(R.id.shimmer_view_container)
    ShimmerFrameLayout mShimmerViewContainer;


    public FragmentMiscelanous() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_miscelanous, container, false);
    ...
    private void initUI() {
        ...
        r_miscelanous.setLayoutManager(llm);
        apiInterface.getCategory("Miscellaneous").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_miscelanous.setAdapter(adapterMenu);
