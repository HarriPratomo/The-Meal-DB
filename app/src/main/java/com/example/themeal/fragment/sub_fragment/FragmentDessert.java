...
public class FragmentDessert extends Fragment {
    ...
    @BindView(R.id.rv_dessert)
    RecyclerView r_dessert;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_dessert, container, false);
    ...
    private void initUI() {
        ...
        r_dessert.setLayoutManager(llm);
        apiInterface.getCategory("Dessert").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_dessert.setAdapter(adapterMenu);
