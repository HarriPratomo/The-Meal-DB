...
public class FragmentVegan extends Fragment {
    ...
    @BindView(R.id.rv_vegan)
    RecyclerView r_vegan;
    @BindView(R.id.shimmer_view_container)
    ShimmerFrameLayout mShimmerViewContainer;


    public FragmentVegan() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_vegan, container, false);
    ...
    private void initUI() {
        ...
        r_vegan.setLayoutManager(llm);
        apiInterface.getCategory("Vegan").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_vegan.setAdapter(adapterMenu);
