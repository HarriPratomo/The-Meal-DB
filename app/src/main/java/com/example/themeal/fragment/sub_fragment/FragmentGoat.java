...
public class FragmentGoat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_goat, container, false);
    ...
    private void initUI() {
        ...
        r_goat.setLayoutManager(llm);
        apiInterface.getCategory("Goat").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
