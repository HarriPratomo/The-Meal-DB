...
public class FragmentBreakfast extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_breakfast, container, false);
    ...
    private void initUI() {
        ...
        r_breakfast.setLayoutManager(llm);
        apiInterface.getCategory("Breakfast").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_breakfast.setAdapter(adapterMenu);
