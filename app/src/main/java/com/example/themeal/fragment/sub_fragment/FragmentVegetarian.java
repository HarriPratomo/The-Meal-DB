...
public class FragmentVegetarian extends Fragment {
    ...
    @BindView(R.id.rv_vegetarian)
    RecyclerView r_vegetarian;
    @BindView(R.id.shimmer_view_container)
    ShimmerFrameLayout mShimmerViewContainer;


    public FragmentVegetarian() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_vegetarian, container, false);
    ...
    private void initUI() {
        ...
        r_vegetarian.setLayoutManager(llm);
        apiInterface.getCategory("Vegetarian").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_vegetarian.setAdapter(adapterMenu);
