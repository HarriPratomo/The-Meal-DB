...
public class FragmentPasta extends Fragment {
    ...
    @BindView(R.id.rv_pasta)
    RecyclerView r_pasta;
    @BindView(R.id.shimmer_view_container)
    ShimmerFrameLayout mShimmerViewContainer;


    public FragmentPasta() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_pasta, container, false);
    ...
    private void initUI() {
        ...
        r_pasta.setLayoutManager(llm);
        apiInterface.getCategory("Pasta").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_pasta.setAdapter(adapterMenu);
