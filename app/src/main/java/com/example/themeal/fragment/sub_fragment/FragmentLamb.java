...
public class FragmentLamb extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_lamb, container, false);
    ...
    private void initUI() {
        ...
        r_lamb.setLayoutManager(llm);
        apiInterface.getCategory("Lamb").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
