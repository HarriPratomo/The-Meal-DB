...
public class FragmentSide extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_side, container, false);
    ...
    private void initUI() {
        ...
        r_side.setLayoutManager(llm);
        apiInterface.getCategory("Side").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
