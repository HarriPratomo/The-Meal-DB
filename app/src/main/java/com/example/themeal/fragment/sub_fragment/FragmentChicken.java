...
public class FragmentChicken extends Fragment {
    ...
    @BindView(R.id.rv_chicken)
    RecyclerView r_chicken;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_chicken, container, false);
    ...
    private void initUI() {
        ...
        r_chicken.setLayoutManager(llm);
        apiInterface.getCategory("Chicken").enqueue(new Callback<ResponseMeal_Item>() {
            @Override
            public void onResponse(Call<ResponseMeal_Item> call, Response<ResponseMeal_Item> response) {
                if (response.isSuccessful()){
                    ...
                    r_chicken.setAdapter(adapterMenu);
